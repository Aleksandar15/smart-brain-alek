...
class App extends Component {
    ...
    onSubmitRegister = (email, password, name) => {
        fetch('https://warm-temple-63763.herokuapp.com/register', {
           method: 'post',
    ...
    createGuest = () => {
        ...
        const name = 'Guest';
        fetch('https://warm-temple-63763.herokuapp.com/signin', {
           method: 'post',
           headers: {'Content-Type': 'application/json'},
           body: JSON.stringify({
               email: email,
    ...
    deleteUser = (email, password) => {
        ...
        fetch('https://warm-temple-63763.herokuapp.com/delete', {
           method: 'delete',
           headers: {'Content-Type': 'application/json'},
           body: JSON.stringify({
               email: email ,
    ...
    onPictureSubmit = () => {
        ...
        if (this.state.input==='')
        {alert("Link cannot be empty!")}else{
        fetch('https://warm-temple-63763.herokuapp.com/imageurl', {
            method: 'post',
            headers: {'Content-Type': 'application/json'},
            body: JSON.stringify({
        ...
        .then(response => {
            if(response){
                fetch('https://warm-temple-63763.herokuapp.com/image', {
                    method: 'put',
                    headers: {'Content-Type': 'application/json'},
                    body: JSON.stringify({
    ...
    componentDidMount () {
        ...
        fetch('https://warm-temple-63763.herokuapp.com/')
        .then(response => response.json())
        .then(console.log)
        this.createGuest();
